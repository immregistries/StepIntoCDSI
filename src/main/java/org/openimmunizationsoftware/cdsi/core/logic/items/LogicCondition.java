...
public abstract class LogicCondition implements LogSink {
  ...
  /**
   * Set the LogicSink for this LogicCondition.
   * This allows LogicCondition to log to the same sink as its parent LogicStep.
   * 
