...
public class SkipTargetDoseForForecast extends LogicStep
{
  ...
  private void printStandard(PrintWriter out) {
	    ...
	    out.println("<p>Evaluate Conditional Skip  addresses times when  a  target dose can be skipped.  A dose should be considered necessary unless it is determined that it can be skipped</p>");
	}
