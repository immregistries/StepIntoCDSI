...
public class OrganizeImmunizationHistory extends LogicStep {
  ...
  public void printPre(PrintWriter out) throws Exception {
    ...
    out.println(
        "   <p>The third step in the process is to look at the patient's immunization history and prepare those records "
            ...
            + "Later in the process (section 4.6), these antigens are assembled into commonly known vaccine groups (vaccine families) "
  ...
  public void printPost(PrintWriter out) {
    ...
    out.println("<h2>Table 4 - 2 Prior to Organize Immunization History Example</h2>");
    out.println("<table>");
    out.println("  <tr>");
