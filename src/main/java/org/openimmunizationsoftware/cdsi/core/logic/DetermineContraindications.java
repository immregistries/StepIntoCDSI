...
/* Adjust logic as follows, finish creating entire file
...
public class DetermineContraindications extends LogicStep {
        ...
        public DetermineContraindications(DataModel dataModel) {
                ...
                caContraindicationBeginAgeDate
                                .setInitialValue(CALCDTCI_1.evaluate(dataModel, this,
                                                caContraindicationElements.getFinalValue()));
                caContraindicationEndAgeDate
                                .setInitialValue(CALCDTCI_2.evaluate(dataModel, this,
                                                caContraindicationElements.getFinalValue()));
