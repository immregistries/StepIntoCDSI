...
public class ForecastDatesAndReasons extends LogicStep{
	...
	private void printTableAndFigure(PrintWriter out){
		...
		out.println("    <td>The goal of this step is to determine if the target dose can be skipped due to a patient‘s age at assessment or immunization history.</td>");
		out.println("  </tr>");
		out.println("  <tr>");
