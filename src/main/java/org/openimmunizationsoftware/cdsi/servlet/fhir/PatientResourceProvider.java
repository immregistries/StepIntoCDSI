...
public class PatientResourceProvider implements IResourceProvider {
    ...
    * to support many different search criteria.
    ...
    *                      the search criteria. The datatype here is StringDt, but
    *                      there are other possible parameter types depending on
   ...
   private void validateResource(Patient thePatient) {
      ...
      if (thePatient.getNameFirstRep().getFamily().isEmpty()) {
         ...
         throw new UnprocessableEntityException(FhirContext.forR4Cached(), outcome);
      }
   }
