...
public abstract class LogicStep {
  ...
  public static final LogicStepType[] STEPS = {LogicStepType.GATHER_NECESSARY_DATA,
      LogicStepType.CREATE_RELEVANT_PATIENT_SERIES, LogicStepType.ORGANIZE_IMMUNIZATION_HISTORY,
      ...
      LogicStepType.EVALUATE_PREFERABLE_INTERVAL, LogicStepType.EVALUATE_ALLOWABLE_INTERVAL,
      LogicStepType.EVALUATE_FOR_LIVE_VIRUS_CONFLICT,
      LogicStepType.EVALUATE_PREFERABLE_VACCINE,
      ...
      LogicStepType.SELECT_PATIENT_SERIES, LogicStepType.IDENTIFY_ONE_PRIORITIZED_PATIENT_SERIES,
      LogicStepType.CLASSIFY_SCORABLE_PATIENT_SERIES, LogicStepType.COMPLETE_PATIENT_SERIES,
