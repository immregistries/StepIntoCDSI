...
- **Documented fix (2026-09-15, SPEC-4.6-0060): CALCDTINT-1 after an inadvertent immediate previous dose.** Same helper as 6.5/7.5: skip the inadvertent VDA and measure from the last Valid/Not Valid non-inadvertent dose.
