...
- **[IMPLEMENTATION]**, partially resolved (2026-09-15, SPEC-4.6-0055): forecast path (7.5) now selects Age and Preferable Interval rows via `RelevantSupportingData` (RELEVANT-1/2 defaults and inclusive bounds) after `DataModelLoader` parses Effective/Cessation Dates. Evaluation-path selection for Age (6.4), Preferable/Allowable Interval (6.5/6.6), and Conditional Skip effective dates remains unresolved.
