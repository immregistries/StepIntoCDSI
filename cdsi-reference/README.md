...
Version comparison (Phase 10), Supporting Data versioning, and FITS run history are not yet built - see `StepIntoCDSi-Specification-Reference-Module-Plan.md` (in the parent `cdsi` directory, one level above this repository's root) for the full 24-phase design.
