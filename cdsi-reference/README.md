...
| `dashboards/step-tests.html`, `dashboards/fits-results.html` | Fully generated (`step-tests dashboard`, `fits-tests dashboard`); committed on purpose so the project owner can share progress with the team - regenerate and commit again whenever there's something new to show, never hand-edited |
